    ...
    <div style={{ background: "#F5EFE6", minHeight: "100vh", paddingTop: 80 }}>
      ...
      <section style={{ background: "#EDE0CE", padding: "80px 32px" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 60, alignItems: "center" }}>
          <AnimBlock from="left">
            <img src={IMGS.aboutimage2} alt="Heritage fort exterior" loading="lazy" style={{ width: "100%", aspectRatio: "4/3", objectFit: "cover", boxShadow: "6px 6px 0 #C9922A", background: "#EDE0CE" }} />
          </AnimBlock>
